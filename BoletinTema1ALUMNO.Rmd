...
```{r}
#a)
help(package = MASS,topic = mammals) #Para ver las características del conjunto de datos mammals del paquete    MASS

help(package = robustbase,topic = Animals2) #Para ver las características del conjunto de datos Animals2 del paquete robustbase
...
commonAnimals <- intersect(df_a, df_m)
...
e.  Determina las diferencia entre los animales que no aparecen en ambos conjuntos.
  ...
  Respuesta: No aparecen debido a que no estan bien escritos. Ejemplo, Arctic fox y artic fox.
...
#Presentan el mismo comportamineto, podemos decir que siguen la distribucion Gaussiana
```
...
libReturn <- library()
libReturn
length(libReturn) #Vemos la longitud de mi libreria, tengo 3 instaladas
libReturn[[2]] [1:5]
...
colSums(sapply(Chile, is.na)) #1 en age, 11 en education, 98 en income, 17 en statusquo, 168 en vote
